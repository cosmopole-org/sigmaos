	...
	import (
		...
		actions "kasper/src/plugins/admin/actions/report"
	...
	type Plugger struct {
		...
		func (c *Plugger) ReadReports() abstract.IAction {
			return utils.ExtractSecureAction(c.Logger, c.Core, c.Actions.ReadReports)
		}
		
		func (c *Plugger) ResolveReport() abstract.IAction {
			return utils.ExtractSecureAction(c.Logger, c.Core, c.Actions.ResolveReport)
		}
		
		func (c *Plugger) ClearReports() abstract.IAction {
			return utils.ExtractSecureAction(c.Logger, c.Core, c.Actions.ClearReports)
		}
