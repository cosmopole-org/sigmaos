	...
	import (
		...
		actions "kasper/src/plugins/game/actions/auth"
	...
	type Plugger struct {
		...
		func (c *Plugger) StartValidation() abstract.IAction {
			return utils.ExtractSecureAction(c.Logger, c.Core, c.Actions.StartValidation)
		}
		
		func (c *Plugger) DoValidation() abstract.IAction {
			return utils.ExtractSecureAction(c.Logger, c.Core, c.Actions.DoValidation)
		}
